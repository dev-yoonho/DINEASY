	...
	$.ajax({
		...
		success : function(response) {
			...
			if (response.coordinateInfo.coordinate[0].lat!=""){
				...
				var targetCoords = [response.coordinateInfo.coordinate[0].lat,response.coordinateInfo.coordinate[0].lon];
				localStorage.setItem('targetCoords', targetCoords);
			}
			else {
				...
				var targetCoords = [response.coordinateInfo.coordinate[0].newLat,response.coordinateInfo.coordinate[0].newLon];
				localStorage.setItem('targetCoords', targetCoords);
			}
